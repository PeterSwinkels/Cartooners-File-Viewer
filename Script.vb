   ...
   Private Sub Display()
      Try
         ...
         With DataFile()
            ...
            NewText.Append(BYTES_TO_TEXT(DecompressLZW(GetBytes(.Data, LocationsE.Script, .Data.Count - LocationsE.Script).ToArray())))
         End With
   ...
   Public Overloads Sub Export(ExportPath As String)
      Try
         ...
         With DataFile()
            ...
            Exported.Append(BYTES_TO_TEXT(DecompressLZW(GetBytes(.Data, LocationsE.Script, .Data.Count - LocationsE.Script).ToArray())))
